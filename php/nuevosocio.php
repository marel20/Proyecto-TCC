<?php
   ...
   include 'conectar.php';
    ...
    $sql="INSERT INTO socios VALUES ('$numero','$nombre','$domicilio','$localidad','$sexo','$sangre','$dni','$nacimiento','$ingreso','$estado','$telefono','$cobrador','$saldo','$categoria',0,0,0,0,0,0,0,0,0)";
