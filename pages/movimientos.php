...
<div
      ...
      <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
        <div class="searchPartner">
          ...
          <div>
            <input href="pago.php" type="submit" class="ingreso2" value="MOSTRAR TODOS">
          </div>
        </div>
      </form>
            ...
            <table class="table">
              ...
              ?>
                  <tr>
                    ...
                    <td data-label="Acciones"><?php echo '<a class="ingreso2" href="movimientos1.php?numero='.$filas["numero"].'">MOVIMIENTOS</a>';?> 
                  </tr>
              <?php
                }
