    ...
    <div class="form">
      <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
        <div class="searchPartner">
          ...
          <div>
            <input href="baja.php" type="submit" class="ingreso2" value="MOSTRAR TODOS">
          </div>
        </div>
      </form>
            ...
            <?php
              if(isset($_POST['enviar'])){
                ...
                while($filas=mysqli_fetch_assoc($resultado)){
                  ...
                  <td data-label="ACCIONES" class="text-center"><?php echo '<a class="ingreso2" href="editar.php?numero='.$filas["numero"].'">EDITAR</a>';?> </br></br> <?php echo '<a class="ingreso2" href="eliminar.php?numero='.$filas["numero"].'" onclick= "return confirmar()">ELIMINAR</a>'; ?></td>
                </tr>
            <?php
                }
