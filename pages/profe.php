  ...
  <body style="background-color: rgb(207, 207, 207)">
    <div id="inicio" class="container-fluid">
      <header>
        ...
        <nav>
        <div class="navbar">
        <img width="70" src="../assets/logo/logo.png" alt="logo_TCC" loading="lazy" />
      ...
      <div class="form">
        <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
          <div class="searchPartner">
            ...
            <div>
              <input href="profe.php" type="submit" class="ingreso2" value="MOSTRAR TODOS">
            </div>
          </div>
        </form>
            ...
            <table class="table">
              ...
              <?php
                if(isset($_POST['enviar'])){
                  ...
                  if(empty($_POST['numero']) && empty($_POST['nombre'])){
                    echo '<script language="javascript"> alert ("Debe ingersar el nombre o numero de socio para poder buscarlo!!!"); window.location.href="profe.php" </script>';
                  }else{
              ...
              ?>
                  <tr>
                    ...
                    <td data-label="ACCIONES"><?php echo '<a class="ingreso2" href="asistencia.php?numero='.$filas["numero"].'">ASISTENCIA</a>';?> 
                  </tr>
              <?php
                }
