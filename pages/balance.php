...
<div
      ...
      <div class="form text-center">
        <a href="facturacion.php" type="submit" class="ingreso2" value="facturacion">FACTURACION EMITIDA</a>
        <a href="ingresos.php" type="submit" class="ingreso2" value="ingresos">INGRESOS MENSUALES</a>
      </div>
      <!--Start Footer-->
      <footer
