  ...
  <body style="background-color: rgb(207, 207, 207)">
    <div id="inicio" class="container-fluid">
      <header>
        ...
        <nav>
          <div class="navbar">
          <a class="ingreso backButton" href="profe.php"
        ...
        <div class="checks-asistencia">
          <h4>Tenis:</h4>
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="flexCheckChecked"><h3>Medio Mes</h3></label>
            </div>
            <div class="form-check">
              <input class="form-check-input" name="hermano" type="checkbox" value="" id="flexCheckChecked"/>
              <label class="form-check-label" for="flexCheckChecked"><h3>Hermano</h3></label>
            </div>
            <div class="form-check">
              <input class="form-check-input" name="conese" type="checkbox" value="" id="flexCheckChecked"/>
              <label class="form-check-label" for="flexCheckChecked"><h3>Conese / Bonificado / Primer Grado</h3></label>
            </div><br>
